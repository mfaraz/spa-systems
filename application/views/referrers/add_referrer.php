...
<div class="panel-body">
	<?php
	echo form_open('referrers/add_referrer', 'role="form" class="form-horizontal"');
	...
	<div class="row-fluid">
		<div class="col-md-6">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title">Referrers Profile</h4>
				</div>
				<div class="panel-body">
                    ...
                    <div class="form-group <?php echo form_is_error('email'); ?>">
                        ...
                        <div class="col-sm-9">
                            <?php echo form_input('email', set_value('email'), 'class="form-control input-sm" ') ;?>
                        </div>
                    </div>
					<div class="form-group <?php echo form_is_error('address'); ?>">
						...
						<div class="col-sm-9">
							<?php echo form_textarea('address', set_value('address'), 'class="form-control input-sm" ') ;?>
						</div>
					</div>
