<div class="panel-heading">
	<h3 class="panel-title">Edit - Member Management</h3>
</div>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group <?php echo form_is_error('firstname'); ?>">
						...
						<div class="col-sm-9">
							<?php echo form_input('firstname', set_value('firstname', $member->firstname), 'class="form-control input-sm" pattern=".{3,50}" title="Allow enter from 3 to 50 characters"') . form_error('firstname'); ?>
						</div>
					</div>
					<div class="form-group <?php echo form_is_error('lastname'); ?>">
						...
						<div class="col-sm-9">
							<?php echo form_input('lastname', set_value('lastname', $member->lastname), 'class="form-control input-sm" pattern=".{3,50}" title="Allow enter from 3 to 50 characters"') . form_error('lastname'); ?>
						</div>
					</div>
					...
					<div class="form-group" >
						...
						<div class="col-sm-9">
							<?php echo form_input('phone', set_value('phone', $member->phone), 'class="form-control input-sm"'); ?>
						</div>
					</div>
					<div class="form-group">
