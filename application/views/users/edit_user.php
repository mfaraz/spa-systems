			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group <?php echo form_is_error('conpassword'); ?>">
						...
						<div class="col-sm-9">
							<?php echo form_input('conpassword', set_value('conpassword'), 'class="form-control input-sm" pattern=".{5,50}" title="Allow enter from 5 to 50 characters"') . form_error('conpassword'); ?>
						</div>
					</div>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<?php echo form_select('role_id', $role, set_value('role_id')); ?>
						</div>
					</div>
					<div class="form-group">
