		...
		<div class="col-md-6">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group">
						<div class="col-sm-12">
							<div class="checkbox"><input type="checkbox" name="mul_welcome" value="1" <?php echo set_checkbox('mul_welcome', 1, ($role->mul_welcome == 1) ? TRUE : FALSE); ?>> Allow to manage <strong>Home</strong> module</div>
						</div>
						<div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            <div class="checkbox"><input type="checkbox" name="mul_rooms" value="1" <?php echo set_checkbox('mul_rooms', 1, ($role->mul_rooms == 1) ? TRUE : FALSE); ?>> Allow to manage <strong>Rooms</strong> module</div>
                        </div>
                        <div class="col-sm-12">
                            <div class="checkbox"><input type="checkbox" name="mul_employees" value="1" <?php echo set_checkbox('mul_employees', 1, ($role->mul_employees == 1) ? TRUE : FALSE); ?>> Allow to manage <strong>Employees</strong> module</div>
                        </div>
                        <div class="col-sm-12">
                            <div class="checkbox"><input type="checkbox" name="mul_referrers" value="1" <?php echo set_checkbox('mul_referrers', 1, ($role->mul_referrers == 1) ? TRUE : FALSE); ?>> Allow to manage <strong>Referrers</strong> module</div>
                        </div>
                        <div class="col-sm-12">
